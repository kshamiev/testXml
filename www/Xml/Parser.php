...
class Xml_Parser
{
    ...
    /**
     * Устанавливает ранее обработанный Xml_Object
     *
     * @param Xml_Object $xml
     */
    public function Set_Xml(Xml_Object $xml)
    {
        $this->_Xml[0] = $xml;
    }
     ...
     * @param string $class_handler обработчик нод (по умолчанию класс Xml_Handler, для примера)
     * @return void
     */
    public function Parser($file, $class_handler = 'Xml_Handler')
    {
        $this->_Level = 0;
        $this->_Xml[$this->_Level] = new Xml_Object('root');
